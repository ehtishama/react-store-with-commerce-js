        ...
        <div className="">
            ...
            <RadioGroup name="sort-by" value={sortBy} onChange={handleSortByChange}>
                <div className="flex gap-2 items-center">
                    ...
                    <label htmlFor="f_1" className="select-none cursor-pointer font-medium text-gray-700 dark:text-gray-200">
                        Price: High to Low
                    </label>
                </div>
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <label htmlFor="f_2" className="select-none cursor-pointer font-medium text-gray-700 dark:text-gray-200">
                        Price: Low to High
                    </label>
                </div>
            </RadioGroup>
