...
const Checkout = () => {
    ...
    const captureOrder = async (stripe, elements) => {
        ...
        const newOrder = {
            ...
            shipping: {
                name: 'International', street: shippingData.address1, town_city: shippingData.city,
                county_state: shippingData.subdivision, postal_zip_code: shippingData.zip,
    ...
    return (
        <div className={"container mx-auto my-4"}>
            <div className={"mx-auto md:w-8/12 lg:w-4/12 space-y-6"}>
                <h2
                    className={
                        "text-4xl text-gray-800 font-medium text-center"
                    }
                >
                    Checkout
                </h2>
